...
const generateTableOfContentes = fullProjectData => {
    const {installation, usage, license, contributing, tests, credits } = fullProjectData;

    return `
    ## Table of Contents
    ${generateInstallationLink(installation)}
    ${generateUsageLink(usage)}
    ${generateLicenseLink(license)}
    ${generateContributingLink(contributing)}
    ${generateTestsLink(tests)}
    ${generateCreditsLink(credits)}
    * [Questions](#questions)
    `;
};
...
const generateLicense = license => {
    ...
    [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0) Please click the badge for more information about this license.
    `;
    const apache = `
    ## License

    [![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) Please click the badge for more information about this license.
    `;
    const mit = `
    ## License 

    [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) Please click the badge for more information about this license.
    `;
    const none = `
    ## License
...
module.exports = fullProjectData => {
    ...
    ## Table of Contents
    ${generateTableOfContentes(fullProjectData)}
